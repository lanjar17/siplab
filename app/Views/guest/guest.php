                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        ...
                        <form method="get" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
                            <div class="input-group input-group-lg">
                                ...
                                <input name="keyword" type="search" class="datepicker_input form-control" id="keyword" placeholder="Design, Code, Marketing, Finance ..." aria-label="Search">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-12 mt-4 mt-lg-0 ms-auto">
                    ...
                    <p class="copyright-text mt-lg-5 mt-4">Copyright © 2023 Lanjar Dwi Saputro. All rights reserved.</p>
