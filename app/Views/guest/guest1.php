...
<head>
    ...
    <link href="<?php echo base_url("bagus/css/bootstrap.css") ?>" rel="stylesheet">
    <link href="<?php echo base_url("bagus/css/fontawesome-all.css") ?>" rel="stylesheet">
    <link href="<?php echo base_url("bagus/css/swiper.css") ?>" rel="stylesheet">
    <link href="<?php echo base_url("bagus/css/magnific-popup.css") ?>" rel="stylesheet">
    <link href="<?php echo base_url("bagus/css/styles.css") ?>" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Scripts -->
    <script src="<?php echo base_url("bagus/js/jquery.min.js") ?>"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?php echo base_url("bagus/js/popper.min.js") ?>"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="<?php echo base_url("bagus/js/bootstrap.min.js") ?>"></script> <!-- Bootstrap framework -->
    <script src="<?php echo base_url("bagus/js/jquery.easing.min.js") ?>"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php echo base_url("bagus/js/swiper.min.js") ?>"></script> <!-- Swiper for image and text sliders -->
    <script src="<?php echo base_url("bagus/js/jquery.magnific-popup.js") ?>"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo base_url("bagus/js/validator.min.js") ?>"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?php echo base_url("bagus/js/scripts.js") ?>"></script> <!-- Custom scripts -->
</body>
